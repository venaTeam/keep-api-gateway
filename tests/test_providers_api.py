...
from src.providers.base.provider_exceptions import ProviderMethodException
...
class TestInvokeProviderMethod:
    ...
    @patch("src.routes.providers.IdentityManagerFactory.get_auth_verifier")
    @patch("src.routes.providers.SecretManagerFactory.get_secret_manager")
    @patch("src.routes.providers.ProvidersFactory.get_provider")
