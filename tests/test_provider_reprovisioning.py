...
@pytest.mark.skip(reason='Provider loading not present in gateway')
def test_provider_reprovisioning_with_updated_config(
    ...
    with patch(
        "src.providers.victoriametrics_provider.victoriametrics_provider.VictoriametricsProvider.validate_scopes",
