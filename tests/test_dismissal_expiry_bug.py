...
import pytest
from src.repositories.db import enrich_entity
...
def wait_for_dismissal_expiry_processing(tenant_id, db_session, max_wait_count=10):
    ...
    try:
        from src.services.dismissal_expiry_bl import DismissalExpiryBl
    except ImportError:
        pytest.skip("DismissalExpiryBl not available in keep-api-gateway")
        return False
...
def test_dismissal_expiry_boolean_comparison_fix(db_session):
    ...
    try:
        ...
        pytest.skip("DismissalExpiryBl not available in keep-api-gateway")
    from src.models.db.alert import AlertEnrichment
...
def test_dismissal_expiry_status_and_disposable_fields_cleanup(db_session):
    ...
    from src.services.enrichments_bl import EnrichmentsBl
    from src.models.action_type import ActionType
    from src.models.db.alert import Alert, AlertEnrichment, LastAlert
    from src.models.db.preset import PresetSearchQuery as SearchQuery
    from src.services.search_engine import SearchEngine
