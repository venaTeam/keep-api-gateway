...
class LastAlert(SQLModel, table=True):
    ...
    status_disposable: bool = Field(
        default=False,
        sa_column=Column(
            Boolean, nullable=False, server_default="false", info={"enrichable": True}
        ),
    )
    dismiss_mode: str | None = Field(
        default=None,
        sa_column=Column(String(20), nullable=True, info={"enrichable": True}),
    )
    dismissed_until: datetime | None = Field(
        default=None,
        sa_column=Column(
            DateTime(timezone=True), nullable=True, info={"enrichable": True}
        ),
    )
    ...
    note: str | None = Field(
        default=None, sa_column=Column(TEXT, nullable=True, info={"enrichable": True})
    )
    deleted: bool = Field(
        default=False,
        sa_column=Column(
    ...
    ticket_url: str | None = Field(
        default=None,
        sa_column=Column(String(500), nullable=True, info={"enrichable": True}),
    )
    ticket_provider_id: str | None = Field(
        default=None,
        sa_column=Column(String(255), nullable=True, info={"enrichable": True}),
    )
    ...
    firing_counter: int = Field(
        default=0,
        sa_column=Column(
            Integer, nullable=False, server_default="0", info={"tracking": True}
        ),
    )
    ...
    started_at: str | None = Field(
        default=None,
        sa_column=Column(String(255), nullable=True, info={"tracking": True}),
    )
...
class Alert(SQLModel, table=True):
    ...
    # === Source 3: Keep Platform Fields (per-occurrence dedup metadata) ===
