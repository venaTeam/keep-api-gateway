...
from src.repositories.cel_to_sql.ast_nodes import DataType
from src.repositories.cel_to_sql.properties_metadata import PropertiesMetadata
from src.repositories.db import engine
from src.repositories.facets_query_builder.get_facets_query_builder import (
    get_facets_query_builder,
)
from src.repositories.facets_query_builder.utils import get_facet_key
from src.models.db.facet import Facet, FacetType
from src.models.facet import (
    CreateFacetDto,
    FacetDto,
    FacetOptionDto,
