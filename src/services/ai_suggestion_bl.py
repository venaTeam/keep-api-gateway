...
from src.config.consts import OPENAI_MODEL_NAME
from src.repositories.db import get_session_sync
from src.models.alert import AlertDto
from src.models.db.ai_suggestion import AIFeedback, AISuggestion, AISuggestionType
from src.models.db.topology import TopologyServiceDtoOut
